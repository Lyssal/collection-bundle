...
use Lyssal\CollectionBundle\Decorator\ElementDecorator;

class ElementAppellation extends AppellationHandler implements AppellationHandlerInterface
{
    /**
     * (non-PHPdoc)
     ...
     */
    public function appellation($element)
    {
     ...
     */
    public function appellationHtml($element)
    {
        return $this->appellation($element);
    }
}
