...
use Lyssal\CollectionBundle\Entity\Univers;
 ...
 * @author Rémi Leclerc
 */
class UniversDecorator extends DecoratorHandler implements DecoratorHandlerInterface
{
    /**
     * (non-PHPdoc)
    ...
    {
        return ($entity instanceof Univers);
    }
